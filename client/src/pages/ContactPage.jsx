        ...
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div className="rounded-3xl bg-blue-600 p-8 shadow-sm md:p-10 text-white">
            ...
            <div className="space-y-6">
              <a href="tel:+919876543210" className="flex items-center gap-4 hover:bg-white/10 p-3 rounded-2xl transition-colors">
              ...
              <a href="mailto:support@serviceworker.com" className="flex items-center gap-4 hover:bg-white/10 p-3 rounded-2xl transition-colors">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white/20">
                  <Mail className="text-white" size={24} />
                </div>
                <div>
                  <p className="text-sm text-blue-200">Email</p>
                  <p className="font-bold text-lg">support@serviceworker.com</p>
                </div>
              </a>

              <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:bg-white/10 p-3 rounded-2xl transition-colors">
              ...
              <div className="flex items-center gap-4 p-3 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="font-bold text-lg">Bhilwara, India</p>
                </div>
              </div>
            </div>
          </div>
