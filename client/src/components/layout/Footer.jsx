    ...
    >
      ...
      <div className="site-shell relative py-12 z-10">
        <div className="grid grid-cols-1 gap-8 border-b border-white/10 pb-8 md:grid-cols-2 xl:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div className="max-w-md">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-300">
              A modern service marketplace built to help people discover trusted experts, compare choices quickly, and book with confidence.
            </p>
            ...
            <div className="mt-5 grid gap-3 text-sm text-slate-300">
              ...
              <p className="inline-flex items-center gap-3">
                ...
                <a href="mailto:support@serviceworker.com" className="hover:text-white">support@serviceworker.com</a>
              </p>
              <p className="inline-flex items-center gap-3">
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white/8 text-emerald-300">
                  <MapPin size={16} />
                </span>
        ...
        <div className="mt-6 flex flex-col gap-3 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
          <p>&copy; {new Date().getFullYear()} ServiceWorker. All rights reserved.</p>
